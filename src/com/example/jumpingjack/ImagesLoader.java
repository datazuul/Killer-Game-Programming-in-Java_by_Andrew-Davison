...
public class ImagesLoader {
    ...
    public int loadStripImages(String fnm, int nunber) {
        String name = getPrefix(fnm);
        if (imagesMap.containsKey(name)) {
            System.out.println("Error : " + name + " already used");
            return 0;
        ...
        BufferedImage[] strip = loadStripImageArray(fnm, nunber);
        if (strip == null) {
            return 0;
        }
    ...
    private void reportTransparency(String fnm, int tranparency) {
