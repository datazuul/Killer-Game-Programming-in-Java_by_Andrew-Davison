...
public class Board {
    ...
    public Board(Positions positions, NetFourByFour netFourByFour) {
    ...
    public void tryPosn(int position, int playerID) {
        positions.set(position, playerID);
        playMove(position, playerID);
    }

    private void playMove(int position, int playerID) {
        nmoves++;
    ...
    private void reportWinner(int playerID) {
        ...
        netFourByFour.gameWon(playerID, score);
    }
}
